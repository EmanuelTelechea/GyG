document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productId) {
        fetch(`gyg-production.up.railway.app/api/articulos/${productId}`)
            ...
            .then(product => {
                ...
                fetch(`gyg-production.up.railway.app/api/categorias/${product.categoria_id}`)
                    .then(response => response.json())
                    .then(category => {
                ...
                fetch(`gyg-production.up.railway.app/api/articulos/categorias/${product.categoria_id}`)
                    .then(response => response.json())
