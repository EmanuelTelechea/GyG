document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productId) {
        fetch(`https://gyg-production.up.railway.app/api/articulos/${productId}`)
            ...
            .then(product => {
                ...
                fetch(`https://gyg-production.up.railway.app/api/categorias/${product.categoria_id}`)
                    .then(response => response.json())
                    .then(category => {
                ...
                fetch(`https://gyg-production.up.railway.app/api/articulos/categorias/${product.categoria_id}`)
                    .then(response => response.json())
