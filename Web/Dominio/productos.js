document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://gyg-production.up.railway.app/api/categorias')
    ...
    // Fetch all products
    fetch('http://gyg-production.up.railway.app/api/articulos')
        .then(response => response.json())
        .then(data => {
    ...
    function filterProductsByCategory(categoryId) {
        ...
        fetch(`http://gyg-production.up.railway.app/api/articulos/categorias/${categoryId}`)
            .then(response => response.json())
            .then(data => {
                displayProducts(data);
            })
    ...
    document.getElementById('sortOptions').addEventListener('change', function() {
        ...
        let fetchUrl = 'http://gyg-production.up.railway.app/api/articulos';

        if (categoryId) {
            fetchUrl = `http://gyg-production.up.railway.app/api/articulos/categorias/${categoryId}`;
        }
